      ...
      <div className='max-w-6xl mx-auto'>
        ...
        >
          ...
          <p className='text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto'>
            Gesek tunai secara offline dan online untuk berbagai kartu kredit
            dan layanan finansial digital dengan rate yang kompetitif dan proses
            yang cepat.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <div className='flex items-start gap-4 mb-4'>
                  <div className='size-16 bg-primary/10 rounded-lg flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:rotate-4 transition-all duration-300'>
